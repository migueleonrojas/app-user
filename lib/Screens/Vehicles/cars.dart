...
import 'package:oil_app/Screens/Vehicles/edit_car.dart';

import 'package:oil_app/Screens/Vehicles/time_line_vehicles_car_notes_and_service_order.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  
      appBar: AppBar(
        ...
        title: AutoSizeText(
          (!selectingVehicleModel)?"Carros":"Selecionados: ${selectedVehiclesModels.length}",          
          style: TextStyle(
          ...
          IconButton(//seleccionar todos los vehiculos
            ...
            IconButton(//eliminar todos los vehiculos seleccionados de la lista de seleccionados
              ...
              onPressed: () async {
                ...
                bool confirm =  await _onBackPressed("De que quieres eliminar los carros seleccionados");
